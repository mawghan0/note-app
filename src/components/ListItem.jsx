...
function ListItem({
  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-3 px-2 w-[95%] mx-auto sm:grid-cols-2 sm:grid sm:gap-3 lg:grid-cols-3">
      ...
      <div className="mb-16 flex flex-col mt-3 px-2 w-[95%] mx-auto sm:grid-cols-2 sm:grid sm:gap-3 lg:grid-cols-3">
